...
import { Stethoscope, ClipboardList, CreditCard, Users } from "lucide-react";
...
const HeroSection = () => {
  return <section className="relative overflow-hidden pt-16 pb-0" style={{
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-4 mb-6 sm:mb-8">
              {benefits.map((benefit, index) => <div key={index} className="flex flex-col items-center gap-2 sm:gap-3 text-center animate-fade-in [animation-fill-mode:both]" style={{
          ...
          <div className="relative flex justify-center lg:justify-end animate-scale-in [animation-delay:0.2s] [animation-fill-mode:both]">
            <div className="relative">
              <img src={heroDoctor} alt="Médica sorrindo pronta para atender" className="w-full max-w-[280px] sm:max-w-sm md:max-w-lg lg:max-w-2xl object-contain drop-shadow-2xl" />
            </div>
          </div>
        </div>
      </div>

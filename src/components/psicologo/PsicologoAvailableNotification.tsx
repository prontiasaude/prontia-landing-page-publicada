...
const PsicologoAvailableNotification = () => {
  ...
  const waitTime = queueCount * 5; // ~5 min por pessoa (sessões são mais longas)
...
export default PsicologoAvailableNotification;
